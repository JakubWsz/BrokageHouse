...
public class UpdateCredentialsListener {
    ObjectMapper objectMapper;
    UserAuthJPARepository userAuthJPARepository;
    PBKDF2Encoder pbkdf2Encoder;

    @KafkaListener(topics = "update-user", groupId = "group-1")
    public void listen(String value) {
        ...
        try {
            ...
            var toUpdate = new UserAuth(
                    userAuth.getId(), userAuth.getUsername(), hashPassword, userAuth.isEnabled(), userAuth.getRoles()
            );
